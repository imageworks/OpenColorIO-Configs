...
config.setRole(OCIO.ROLE_COLOR_TIMING, "lg10")
config.setRole(OCIO.ROLE_COMPOSITING_LOG, "lgf")
config.setRole(OCIO.ROLE_COLOR_PICKING,"cpf")
config.setRole(OCIO.ROLE_DATA,"ncf")
config.setRole(OCIO.ROLE_DEFAULT,"ncf")
config.setRole(OCIO.ROLE_MATTE_PAINT,"vd8")
...
cs.setBitDepth(OCIO.BIT_DEPTH_UINT16)
t = OCIO.FileTransform('lg16.spi1d',interpolation=OCIO.INTERP_NEAREST )
...
t = OCIO.FileTransform('lg10.spi1d',interpolation=OCIO.INTERP_NEAREST )
cs.setTransform(t, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
...
t = OCIO.FileTransform('lgf.spi1d',interpolation=OCIO.INTERP_LINEAR)
cs.setTransform(t, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
...
cs.setBitDepth(OCIO.BIT_DEPTH_UINT10)
t = OCIO.FileTransform('gn10.spi1d',interpolation=OCIO.INTERP_NEAREST)
cs.setTransform(t, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
...
groupTransform.prependTransform(OCIO.FileTransform('version_8_whitebalanced.spimtx',direction=OCIO.TRANSFORM_DIR_INVERSE))
groupTransform.prependTransform(OCIO.FileTransform('vd16.spi1d',interpolation=OCIO.INTERP_NEAREST ))
...
groupTransform = OCIO.GroupTransform()
groupTransform.prependTransform(OCIO.FileTransform('version_8_whitebalanced.spimtx',direction=OCIO.TRANSFORM_DIR_INVERSE))
groupTransform.prependTransform(OCIO.FileTransform('vd10.spi1d',interpolation=OCIO.INTERP_NEAREST ))
cs.setTransform(groupTransform, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
...
groupTransform = OCIO.GroupTransform()
groupTransform.prependTransform(OCIO.FileTransform('version_8_whitebalanced.spimtx',direction=OCIO.TRANSFORM_DIR_INVERSE))
groupTransform.prependTransform(OCIO.FileTransform('vd8.spi1d',interpolation=OCIO.INTERP_NEAREST ))
cs.setTransform(groupTransform, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
...
cs.setBitDepth(OCIO.BIT_DEPTH_UINT10)
groupTransform = OCIO.GroupTransform()
groupTransform.prependTransform(OCIO.FileTransform('hdOffset.spimtx',interpolation=OCIO.INTERP_NEAREST ,direction=OCIO.TRANSFORM_DIR_INVERSE))
...
cs.setBitDepth(OCIO.BIT_DEPTH_UINT8)
groupTransform = OCIO.GroupTransform()
groupTransform.prependTransform(OCIO.FileTransform('diffuseTextureMultiplier.spimtx',interpolation=OCIO.INTERP_NEAREST ,direction=OCIO.TRANSFORM_DIR_FORWARD))
groupTransform.prependTransform(OCIO.ColorSpaceTransform(dst='lnf',src='vd16'))
cs.setTransform(groupTransform, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
"""
...
cs.setBitDepth(OCIO.BIT_DEPTH_F32)
t=OCIO.FileTransform(src='cpf.spi1d',interpolation=OCIO.INTERP_LINEAR )
cs.setTransform(t, OCIO.COLORSPACE_DIR_TO_REFERENCE)
config.addColorSpace(cs)
...
cs.setBitDepth(OCIO.BIT_DEPTH_UINT8)
groupTransform = OCIO.GroupTransform()
groupTransform.prependTransform(OCIO.ColorSpaceTransform(src='lnf', dst='lg10'))
groupTransform.prependTransform(OCIO.FileTransform('spi_ocio_srgb_test.spi3d',interpolation=OCIO.INTERP_LINEAR))
...
groupTransform = OCIO.GroupTransform()
groupTransform.prependTransform(OCIO.ColorSpaceTransform(src='lnf', dst='lg10'))
groupTransform.prependTransform( OCIO.FileTransform('colorworks_filmlg_to_p3.3dl',interpolation=OCIO.INTERP_LINEAR))
cs.setTransform(groupTransform, OCIO.COLORSPACE_DIR_FROM_REFERENCE)
config.addColorSpace(cs)
